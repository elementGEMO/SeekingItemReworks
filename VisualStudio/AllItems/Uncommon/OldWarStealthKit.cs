...
namespace SeekerItems.Uncommon
{
    internal class OldWarStealthKit : RiskItem
    {
        ...
        //"Falling below " + "25% health ".Style(Color.cIsHealth) + "causes you to gain " + "40% movement speed".Style(Color.cIsUtility) + ", become " + "invisible ".Style(Color.cIsUtility) + "for " + "5s ".Style(Color.cIsUtility) + "and " + "cleanse 2 ".Style(Color.cIsUtility) + "(+1 per stack) ".Style(Color.cStack) + "debuffs".Style(Color.cIsDamage) + ". Recharges every " + "30 ".Style(Color.cIsUtility) + "(-50% per stack) ".Style(Color.cStack) + "seconds."
        ) { }
    }
}
